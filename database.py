...
def get_latest_vanco_tdm(msyt):

    """

    Lay ban ghi TDM Vancomycin GAN NHAT (tdm_date lon nhat) cua 1 benh nhan theo MSYT.

    Dung de Tab 4 (Vancomycin) load lai thong tin benh nhan + che do lieu dung da nhap

    o lan TDM truoc. Tra ve dict (1 ban ghi) hoac None neu chua co du lieu.
    ...
    try:
        ...
        res = (supabase.table("vanco_tdm_history").select("*").eq("msyt", msyt)
...
# ==========================================
# 7. MIGRATION CAN CHAY TREN SUPABASE (SQL Editor) DE HO TRO PHUONG PHAP COLLIN 2019
#    -- CHI can ALTER 2 bang hien co, KHONG tao bang moi:
#
